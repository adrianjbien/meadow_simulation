...
if __name__ == '__main__':
    ...
    xy_limit, sheep_step_length, wolf_step_length = (
        pars.get_values_from_config())
    max_round_num = args.rounds

    json = 'pos.json'
    csv = 'alive.csv'

    simulation = SimulationController(max_round_num, number_of_sheeps,
                                      xy_limit, sheep_step_length,
                                      wolf_step_length, json, csv)
